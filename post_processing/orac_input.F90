...
subroutine determine_channel_indexing(fname, indexing, verbose)
   ...
   call ncdf_read_array(ncid, "y_id",    indexing%Y_Id)
   call ncdf_read_array(ncid, "view_id", indexing%View_Id)
   call ncdf_read_array(ncid, "ch_is",   indexing%Ch_Is)
   call ncdf_read_array(ncid, "rho_flags", rho_flags)
